...
> <img src="/assets/images/INU/python/how_recursion.png" alt="how_recursion_Procdess" width="70%" min-width="200px" itemprop="image"><br>`점화식으로 표현된 재귀 함수`<br><br>
...
- 꼬리 재귀 (Tail Recursion)
  - 재귀 호출 할 때 더 이상 기억해 줄 것이 없도록 한다.
    - 즉, 재귀 호출의 끝에 도달하여 도출된 결과를 가지고 roll back하며 계산할 것이 남이 있지 않는다.
